...
/// <summary>キャラクター（<c>characters</c>）の検索・選択ダイアログ。</summary>
public partial class CharacterPickerDialog : Form
{
    ...
    /// <summary>選択結果のキャラクター ID。</summary>
    public int? SelectedId { get; private set; }

    public CharacterPickerDialog(CharactersRepository repo)
    {
    ...
    private void OnOkClick()
    {
        ...
        if (lvResults.SelectedItems[0].Tag is Character c) SelectedId = c.CharacterId;
    }
}
