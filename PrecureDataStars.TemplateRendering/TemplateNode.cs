...
/// <summary>プレースホルダノード {NAME} または {NAME:opt=val,opt=val}。</summary>
...
/// <summary>ブロック繰り返しノード {#BLOCKS}...{/BLOCKS}。</summary>
...
/// <summary>条件分岐ノード <c>{?NAME}...{/?NAME}</c>。 プレースホルダ <see cref="Name"/> の解決値が非空の場合のみ <see cref="Body"/> を展開する。</summary>
