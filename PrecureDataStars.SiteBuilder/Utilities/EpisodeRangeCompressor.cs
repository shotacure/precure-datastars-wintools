...
{
    /// <summary>話数集合を圧縮表記に変換する（「#」プレフィックスを各範囲の先頭にだけ付ける形）。 例：[1,2,3,4,8,11,12,13] → "#1～4, 8, 11～13"</summary>
    ...
    /// <summary>「全話」判定付きの圧縮表記を返す。 <paramref name="episodeNos"/> が <paramref name="allEpisodeNos"/> をすべて含むなら 末尾に「(全話)」を付ける。</summary>
