...
{
    /// <summary>CD-DA 解析で共通的に使用するユーティリティメソッド群。 フレーム↔時間変換、MSF→LBA 変換、バイト列の16進表示、CD-Text デコード等を提供する。</summary>
    internal static class Helpers
    {
        /// <summary>CD-DA フレーム数を "MM:SS.FF" 形式の文字列に変換する。 CD-DA の 1 秒は 75 フレーム（= 75 セクタ = 176,400 バイト）。</summary>
        ...
        /// <summary>MSF (Minutes/Seconds/Frames) アドレスを LBA (Logical Block Address) に変換する。</summary>
        ...
        /// <summary>CD-Text のバイト列を文字列にデコードする。 charset ニブル 2 = MS-JIS (Shift_JIS/CP932)、その他 = Latin-1 (ISO-8859-1)。 デコード失敗時は Latin-1 にフォールバックする。</summary>
