...
public sealed class ProductCompany
{
    ...
    /// <summary>新規商品作成時のレーベル既定にする社かどうか。マスタ全体で最大 1 行のみ true となる （排他性は <see cref="Repositories.ProductCompaniesRepository"/> 内のトランザクションで担保）。</summary>
    public bool IsDefaultLabel { get; set; }

    /// <summary>新規商品作成時の販売元既定にする社かどうか。マスタ全体で最大 1 行のみ true となる （排他性は <see cref="Repositories.ProductCompaniesRepository"/> 内のトランザクションで担保）。</summary>
