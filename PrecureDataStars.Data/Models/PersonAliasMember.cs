...
public sealed class PersonAliasMember
{
    ...
    /// <summary>メンバーが人物名義の場合の参照先（→ person_aliases.alias_id）。 <see cref="MemberKind"/> が PERSON のとき非 NULL。</summary>
...
/// <summary><see cref="PersonAliasMember.MemberKind"/> の種別。</summary>
