...
├─ Block #1 (1×1)              ← {#BLOCKS:first} で展開される最初のブロック
│    leading_company_alias_id = 「講談社」屋号 ID
│    ├─ [COMPANY]  #1  「なかよし」屋号（雑誌名を屋号として登録）
│    └─ [PERSON]   #2  「上北ふたご」名義
├─ Block #2 (1×1)              ← {#BLOCKS:rest} の最初のブロック
│    └─ [COMPANY]  #1  「たのしい幼稚園」屋号
└─ Block #3 (1×1)              ← {#BLOCKS:rest} の続き
     └─ [COMPANY]  #1  「おともだち」屋号
```
