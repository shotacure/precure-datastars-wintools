...
### v1.1.5 — CDAnalyzer のメディア種別自動判定によるドライブ占有解消

**DB スキーマ変更なし**。`PrecureDataStars.CDAnalyzer` の SCSI 周りに対する局所修正のみ。
...
- `README.md`: 先頭バナーに v1.1.5 を追加、プロジェクト詳細表の CDAnalyzer 説明にメディア種別自動判定の仕様を追記、「音楽カタログ登録 → A. CD の登録」直下に v1.1.5 メモを挿入、本変更履歴エントリを追記
